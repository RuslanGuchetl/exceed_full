...
// extracted by mini-css-extract-plugin
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    exports.newPassCheck = undefined;
    ...
    var newPassCheck = exports.newPassCheck = function newPassCheck() {
      ...
      if (p.length >= 1) {
        if (c < 6) {
          confPw.setCustomValidity("Password is too short! min 6 char");
        } else {
          if (c >= 35) {
            console.log('...............', c);
            confPw.setCustomValidity("Password is too long! max 35 char");
          } else {
            confPw.setCustomValidity('');
          }
        }
      } else {
        confPw.setCustomValidity('error');
      }
    };
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    var _newpassword = __webpack_require__(38);
      ...
      },
        {
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              ...
              fireRedirect && _react2.default.createElement(_reactRouter.Redirect, { to: '/profile' })
            );
          }
        }]);
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    var _editInput = __webpack_require__(42);
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    var _bd = __webpack_require__(44);

    var _arrayEditor = __webpack_require__(43);
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    function checkurl(x) {
      ...
      if (!x.pathname.includes('/profile')) {
        return _react2.default.createElement(_reactRouter.Redirect, { to: "/" });
      }
    }
        ...
        value: function render() {
            ...
            xhr.onload = function () {
              if (xhr.readyState === xhr.DONE) {
                if (xhr.status === 295) {
                  ...
                  localStorage.setItem('id', myObject._id);
                  localStorage.setItem('password', myObject.password);
                  localStorage.setItem('name', myObject.name);
                  localStorage.setItem('login', myObject.login);
                  localStorage.setItem('email', myObject.email);
                  localStorage.setItem('age', myObject.age);
                  localStorage.setItem('gender', myObject.gender);
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "form",
                { className: "form-bottom", onSubmit: logStore },
                _react2.default.createElement(
                  "div",
              ...
              fireRedirect && _react2.default.createElement(_reactRouter.Redirect, { to: from || '/profile' })
            )
          );
        }
      }]);
        ...
        value: function render() {
          ...
          var store = function store(e) {
            ...
            if (newLogin.value != '' && userPw.value === confPw.value && userPw.value != '' && newMail.match(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)) {
              ...
              xhr.open("POST", url, true);
              xhr.setRequestHeader("Content-Type", "application/json");
              var data = JSON.stringify({"login": newLogin, "password": userPw.value, "email": newMail, "name": userName.value, "age": userAge.value});
              xhr.onload = function () {
                if (xhr.readyState === xhr.DONE) {
                  if (xhr.status === 290) {
                    _this2.setState({ fireRedirect: true });
