...
/* harmony import */ var _MemoryRouter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
...
/* harmony import */ var _Prompt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
...
/* harmony import */ var _Redirect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
/* harmony import */ var _Route__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
...
/* harmony import */ var _StaticRouter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(15);
...
/* harmony import */ var _Switch__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(14);
...
/* harmony import */ var _matchPath__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6);
...
/* harmony import */ var _withRouter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(13);
...
var MemoryRouter = __webpack_require__(17);
...
var Prompt = __webpack_require__(16);
...
var StaticRouter = __webpack_require__(15);
...
var Switch = __webpack_require__(14);
...
var withRouter = __webpack_require__(13);
...
(function () {
  ...
  var AMD = "function" === 'function' && __webpack_require__(49);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(51), __webpack_require__(50)))
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(0);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _matchPath__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
  ...
  _createClass(EditItem, [{
      ...
      if (userNewPass == '') {
        ...
        xhr1.onload = function () {
          if (xhr1.readyState === xhr1.DONE) {
            ...
            } else if (xhr1.status === 401 || xhr1.status === 507) {
        ...
        xhr2.onload = function () {
          if (xhr2.readyState === xhr2.DONE) {
            ...
            } else if (xhr2.status === 401 || xhr2.status === 507) {
        ...
        if (ready) {
          ...
          xhr.onload = function () {
            if (xhr.readyState === xhr.DONE) {
              ...
              } else if (xhr.status === 401 || xhr.status === 507) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        fireRedirect && _react2.default.createElement(_reactRouter.Redirect, { to: '/profile/homes' }),
          ...
          this.state.data.map(function (item, key) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  "a",
                  { onClick: _this2.DeleteUser.bind(_this2), href: "", id: item._id, className: "delBtn" },
                  "Delete"
                )
              )
            );
...
var _tableList = __webpack_require__(41);
  ...
  _createClass(UsersList, [{
      ...
      xhr.onload = function () {
        if (xhr.readyState === xhr.DONE) {
          if (xhr.status === 200) {
            ...
            return window.location.href = "/profile/homes";
          }
        }
      };
      xhr.send(data);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("div", { className: "pageLoader" }),
...
var EditInput = function (_React$Component) {
  ...
  _createClass(EditInput, [{
    ...
    value: function addItm() {
      ...
      c = c.trim();
      if (c.match(/^(([A-za-z]{3,10})((.)?)(([A-za-z]{1,7})?)((.)?)([0-9])?)$/)) {
        var xhr = new XMLHttpRequest();
    ...
    value: function save() {
      ...
      if (c.match(/^(([A-za-z]{3,10})((.)?)(([A-za-z]{1,7})?)((.)?)([0-9])?)$/)) {
        ...
        if (this.props.onSave) {
          this.props.onSave(c, this.props.id);
...
var _editInput = __webpack_require__(43);
  ...
  _createClass(ArrayEditor, [{
    ...
    value: function edit(data, id) {
      ...
      for (var i = 0; i < arr1.length; i++) {
        if (arr1[i]._id == id) {
          ...
          array[i] = arr1[i];
          this.setState({ arr: array, selectedLabel: data });
        }
      }
    }
  }, {
        ...
        for (var i = 0; i < arr1.length; i++) {
          if (arr1[i]._id == id) {
            ...
            if (arr1 === undefined || arr1.length == 0) {
              ...
              this.setState({ arr: arr1, selectedLabel: arr1[i][str], selectValue: arr1[i]._id });
              var selectedValue = arr1[i]._id;
              if (this.props.getHome) {
                this.props.getHome(selectedValue);
                this.props.getHome.bind(this);
              }
            } else {
              this.setState({ arr: arr1, selectedLabel: arr1[i - 1][str], selectValue: arr1[i - 1]._id });
              var _selectedValue = arr1[i - 1]._id;
              if (this.props.getHome) {
                this.props.getHome(_selectedValue);
                this.props.getHome.bind(this);
              }
            }
          }
    ...
    value: function handleChange(event) {
      ...
      for (var i = 0; i < arr.length; i++) {
        if (this.props.array[i][this.props.idName] == selectedValue) {
          this.setState({ currentHome: this.props.array[i] });
          if (this.props.getHome) {
            this.props.getHome(selectedValue);
            this.props.getHome.bind(this);
          }
...
var _arrayEditor = __webpack_require__(44);
  ...
  _createClass(Homes, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        show1 && _react2.default.createElement(_arrayEditor2.default, { urlUpd: '/updatehome', urlAdd: '/savehome', btnId: 'homebtn', array: this.state.data, idName: '_id',
          field: 'homeName', title: 'home', getHome: this.getItem.bind(this), hideComp: this.hider.bind(this),
          updArr: this.updateArray.bind(this) }),
        show2 && _react2.default.createElement(_arrayEditor2.default, { urlUpd: '/updateroom', urlAdd: '/saveroom', btnId: 'roombtn', array: this.state.data2,
          val: this.state.item, idName: '_id', field: 'roomName', title: 'room',
          updArr: this.updateArray.bind(this) })
      );
    }
  }]);
...
var _homes = __webpack_require__(45);
...
var Profile = function Profile(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouterDom.Route, { path: "/profile/homes", component: _homes2.default }),
...
function checkurl(x) {
  ...
  xhr1.onload = function () {
    if (xhr1.readyState === xhr.DONE) {
      if (xhr1.status === 200) {
        var myobject1 = JSON.parse(xhr1.responseText);
...
var Compare = exports.Compare = function Compare() {
  ...
  var pass = (0, _jsSha2.default)(userPw.value);
...
var _compare = __webpack_require__(47);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          fireRedirect && _react2.default.createElement(_reactRouter.Redirect, { to: from || '/profile/homes' })
        )
      );
    }
  }]);
...
var _validation = __webpack_require__(52);
...
var _registr = __webpack_require__(53);
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(66),B=__webpack_require__(25),C=__webpack_require__(11),ba=__webpack_require__(65),da=__webpack_require__(64),ea=__webpack_require__(63),fa=__webpack_require__(62),ia=__webpack_require__(59),D=__webpack_require__(24);
...
var m=__webpack_require__(25),n=__webpack_require__(24),p=__webpack_require__(11),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
