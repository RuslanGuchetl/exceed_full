...
var AddItem = function (_React$Component) {
  ...
  _createClass(AddItem, [{
    ...
    value: function valid() {
      document.getElementById(this.props.title).style.border = '2px solid #07d5df';
      document.getElementById(this.props.btnId).style.border = 'none';
    }
  }, {
    key: 'update',
    ...
    value: function save() {
      ...
      if (c.match(/^([A-za-z]{3,15})([\s\/.\-]?)((\w+)?)$/)) {
        ...
        document.getElementById(this.props.title).style.border = '2px solid red';
        document.getElementById(this.props.btnId).style.border = '2px solid red';
      }
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'btn saveEditHome saveHomeBtn homeBtn',
                id: this.props.btnId,
...
var EditInput = function (_React$Component) {
  ...
  _createClass(EditInput, [{
    key: 'valid',
    value: function valid() {
      document.getElementById(this.state.title).style.border = '2px solid #07d5df';
    }
  }, {
    key: 'update',
    value: function update(e) {
...
var ArrayEditor = function (_React$Component) {
  ...
  _createClass(ArrayEditor, [{
    ...
    value: function edit(data) {
      data = data.trim();
      if (data.match(/^([A-za-z]{3,15})([\s\/.\-]?)((\w+)?)$/)) {
        for (var i = 0; i < this.props.array.length; i++) {
          if (this.props.array[i] == this.state.currentHome) {
            this.props.array[i][this.props.field] = data;
      ...
      for (var i = 0; i < arr.length; i++) {
        if (this.props.array[i][this.props.idName] == selectedValue) {
          ...
          if (this.props.getHome) {
            this.props.getHome(this.props.array[i].rooms, 1);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        show && _react2.default.createElement(_editInput2.default, { value: this.state.selectedLabel,
...
var _additem = __webpack_require__(43);
...
var Homes = function (_React$Component) {
  ...
  _createClass(Homes, [{
    ...
    key: 'getItem',
    value: function getItem(data, val) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_additem2.default, { title: 'home', url: '/savehome', btnId: 'homebtn' }),
        show1 && _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_arrayEditor2.default, { array: this.state.data, idName: '_id', field: 'homeName', title: 'home', getHome: this.getItem.bind(this) }),
          _react2.default.createElement(_additem2.default, { title: 'room', url: '/saveroom', btnId: 'roombtn' })
        ),
        show2 && _react2.default.createElement(_arrayEditor2.default, { array: this.state.item, idName: 'id', field: 'roomName', title: 'room' })
      );
    }
  }]);
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(67),B=__webpack_require__(25),C=__webpack_require__(11),ba=__webpack_require__(66),da=__webpack_require__(65),ea=__webpack_require__(64),fa=__webpack_require__(63),ia=__webpack_require__(60),D=__webpack_require__(24);
