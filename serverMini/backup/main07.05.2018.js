...
/* harmony import */ var _MemoryRouter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
...
/* harmony import */ var _Prompt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
...
/* harmony import */ var _Redirect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
/* harmony import */ var _Route__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);
...
/* harmony import */ var _Router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
...
/* harmony import */ var _StaticRouter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
...
/* harmony import */ var _Switch__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13);
...
/* harmony import */ var _matchPath__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7);
...
/* harmony import */ var _withRouter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(12);
...
var createBrowserHistory = __webpack_require__(27);
...
var createHashHistory = __webpack_require__(26);
...
var MemoryRouter = __webpack_require__(16);
...
var Prompt = __webpack_require__(15);
...
var StaticRouter = __webpack_require__(14);
...
var Switch = __webpack_require__(13);
...
var matchPath = __webpack_require__(7);
...
var withRouter = __webpack_require__(12);
...
"use strict";
/* harmony import */ var path_to_regexp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(0);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _matchPath__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var resolve_pathname = __webpack_require__(21);

// EXTERNAL MODULE: ./node_modules/value-equal/index.js
var value_equal = __webpack_require__(20);
...
/* harmony import */ var hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(0);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var history_PathUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
...
/* harmony import */ var _Router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var history_createMemoryHistory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(52), __webpack_require__(51)))
...
var _savervalid = __webpack_require__(38);

var _jsSha = __webpack_require__(17);

var _jsSha2 = _interopRequireDefault(_jsSha);

var _radiobuttons = __webpack_require__(37);
  ...
  _createClass(EditItem, [{
    ...
    value: function handleSubmit(event) {
      ...
      if (userNewPass == '') {
        ...
        xhr1.onload = function () {
          if (xhr1.readyState === xhr1.DONE) {
            ...
            if (xhr1.status === 200) {
              ...
              return alert(xhr1.responseText);
        ...
        var url2 = "/update";
        var _body = document.getElementById('root');
        _body.className += ' ' + 'modalBlock';
        ...
        xhr2.onload = function () {
          if (xhr2.readyState === xhr2.DONE) {
            _body.className = _body.className.replace(" modalBlock", "");
            if (xhr2.status === 200) {
              localStorage.setItem('login', userLogin);
              localStorage.setItem('email', userMail);
              localStorage.setItem('name', userName);
              ...
              localStorage.setItem('age', userAge);
              localStorage.setItem('gender', userGender);
              return alert(xhr2.responseText);
        ...
        var formValues1 = this.state.formValues;
        formValues1['newPass'] = '';
        formValues1['current'] = '';
        this.setState({ formValues: formValues1 });
        xhr2.send(data);
      }
    }
  }, {
...
var _editProfile = __webpack_require__(39);
...
var ProductList = function (_React$Component) {
  ...
  _createClass(ProductList, [{
      ...
      xhr.onload = function () {
        if (xhr.readyState === xhr.DONE) {
          ...
          if (xhr.status == 200) {
            ...
            var arr2 = [];
            var strId = arr.arraycateg[0]._id;
            arr.arrayitem.forEach(function (elem) {
              if (elem['parentId'] == strId) {
                arr2.push(elem);
              }
            });
            _this2.setState({
              arrayCategories: arr.arraycateg,
              arrayItems: arr.arrayitem,
              CategId: strId,
              currentArray: arr2,
              isload: true,
              show: true
            });
            document.getElementById(strId).className += ' activeItems';
          } else if (xhr.status == 401) {
            window.location.href = "/";
          }
        }
    ...
    value: function handleCheck(e) {
      ...
      var arr1 = this.state.arrayItems;
      var arr2 = [];
      arr1.forEach(function (elem) {
        if (elem['parentId'] == currentCateg) {
          arr2.push(elem);
        }
      });
      e.currentTarget.className += " activeItems";
      this.setState({ currentArray: arr2, prevItem: e.currentTarget, currentCategId: currentCateg });
      if (!this.state.prevItem) {
        document.getElementById(this.state.CategId).className = 'MenuItems';
        document.getElementById(this.state.currentCategId).className = 'MenuItems';
      } else {
        document.getElementById(this.state.currentCategId).className = 'MenuItems';
        var prev = this.state.prevItem;
        prev.className = 'MenuItems';
      }
    }
  }, {
    key: "DeleteById",
    value: function DeleteById(name) {
      var _this3 = this;
      ...
      if (sure) {
        ...
        if (name == 'category') {
          var arr1 = this.state.arrayCategories;
          var arr2 = this.state.arrayItems;
          for (var j = 0; j < arr2.length; j++) {
            if (arr2[j]['parentId'] == id) {
              arr2.splice(j, 1);
            }
          }
          var arCateg = [];
          ...
          for (var i = 0; i < arr1.length; i++) {
            if (arr1[i]._id == id) {
              document.getElementById(arr1[i]._id).className += 'MenuItems';
              arr1.splice(i, 1);
              if (i == 0 && !(arr1.length == 0)) {
                (function () {
                  var cid = arr1[i]._id;
                  var showArr = [];
                  arr2.forEach(function (elem) {
                    if (elem['parentId'] == cid) {
                      showArr.push(elem);
                    }
                  });
                  arCateg = arr1;
                  ...
                  curCid = arr1[i]._id;
                  curAr = showArr;
                  document.getElementById(arr1[i]._id).className += ' activeItems';
                })();
              } else if (i > 0 && !(arr1.length == 0)) {
                (function () {
                  var cid = arr1[i - 1]._id;
                  var showArr2 = [];
                  arr2.forEach(function (elem) {
                    if (elem['parentId'] == cid) {
                      showArr2.push(elem);
                  ...
                  curCid = cid;
                  curAr = showArr2;
                  console.log('.........', curAr, curCid);
                  _this3.setState({
                    arrayCategories: arCateg,
                    arrayItems: arItems,
                    currentCategId: curCid,
                    currentArray: curAr,
                    prevItem: '',
                    isload: true
                  });
                  document.getElementById(cid).className += ' activeItems';
                })();
              } else {
                arCateg = [];
                arItems = [];
      ...
      if (arr.length > 0) {
        if (localStorage.getItem('role') == 'admin') {
          return arr.map(function (item) {
            return _react2.default.createElement(
              "li",
              { key: item._id, className: "MenuItems", "data-id": item._id, id: item._id,
                onClick: _this4.handleCheck.bind(_this4) },
              item.categoryName,
              _react2.default.createElement("span", { className: "editCatPen" }),
              _react2.default.createElement("span", { className: "deleteCatX", onClick: _this4.deleteCategId.bind(_this4) })
            );
          });
        } else {
          return arr.map(function (item) {
            return _react2.default.createElement(
              "li",
              { className: "MenuItems", key: item._id, "data-id": item._id, id: item._id,
                onClick: _this4.handleCheck.bind(_this4) },
              item.categoryName
            );
          });
          ...
          _react2.default.createElement(
            ...
            show3 && _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement("span", { className: "CategInputCheck", onClick: this.addCateg.bind(this) }),
                _react2.default.createElement("span", { className: "CategInputCancel", onClick: this.categCancel.bind(this) })
              )
            ),
            show2 && _react2.default.createElement(
              "div",
              { className: "plusIcon", onClick: this.AddCateg.bind(this) },
              "+ Add Category"
            )
          )
        ),
          ...
          this.state.data.map(function (item, key) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  "p",
                  { onClick: _this2.DeleteUser.bind(_this2), id: item._id, className: "delBtn" },
                  "Delete"
                )
              )
            );
...
var _tableList = __webpack_require__(42);
      ...
      xhr.onload = function () {
        if (xhr.readyState === xhr.DONE) {
          if (xhr.status == 200) {
            ...
            _this2.setState({ data: obj, isload: true });
          } else if (xhr.status == 401) {
            window.location.href = "/";
  ...
  _createClass(EditInput, [{
    ...
    value: function addItm() {
      ...
      if (c.match(/^(([A-za-z0-9]{1,15})((.)?)(([A-za-z0-9]{1,15})?)((.)?)(([A-za-z0-9]{1,15})?)((.)?)([0-9]{1,5})?)$/)) {
        ...
        if (this.props.onAdd) {
          var bool = true;
          this.props.onAdd(this.props.title, bool);
    ...
    key: 'CancelInp',
    value: function CancelInp() {
      this.setState({ value: this.props.value });
      this.valid();
    }
  }, {
    key: 'CancelInp2',
    value: function CancelInp2() {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { className: 'btnSelect DeleteItem',
        ...
        show3 && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { className: 'btnSelect DeleteItem doubleBtn',
...
var _editInput = __webpack_require__(44);
...
var ArrayEditor = function (_React$Component) {
  ...
  function ArrayEditor(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ArrayEditor.__proto__ || Object.getPrototypeOf(ArrayEditor)).call(this, props));

    _this.state = {
      arr: _this.props.array,
      selectValue: '',
      selectedLabel: '',
      value: '',
      optionAdd: false,
  ...
  _createClass(ArrayEditor, [{
    key: 'edit',
    value: function edit(data, id, price) {
      var str = this.props.title + 'Name';
        ...
        for (var i = 0; i < arr1.length; i++) {
          if (arr1[i]._id == id) {
            ...
            if (arr1 === undefined || arr1.length == 0) {
              ...
              var _selectedValue = arr1[i - 1]._id;
              if (this.props.getCategory) {
                this.props.getCategory(_selectedValue);
                this.props.getCategory.bind(this);
              }
            }
          }
    ...
    value: function handleChange(event) {
      ...
      var Label = selectBox.options[selectBox.selectedIndex].label;
    ...
    key: 'list',
    value: function list(arr, props) {
      if (arr.length > 0) {
        return arr.map(function (item) {
          return _react2.default.createElement('option', { className: 'options', key: item[props.idName], value: item[props.idName], label: item[props.field] });
        });
      } else {
        return;
      }
    ...
    key: 'render',
    value: function render() {
      var spacebtn = this.props.title + 'sEditor';
      var savebtn = this.props.title + 'EditorUpd';
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            { className: 'homeLabel toUpperLabel' },
            this.props.title
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              'select',
              { className: 'form-control home-select', value: this.state.selectValue,
                onChange: this.handleChange.bind(this) },
              _react2.default.createElement('option', { value: '', label: 'Choose...', disabled: true }),
        ...
        _react2.default.createElement(_editInput2.default, { value: this.state.selectedLabel,
...
var _arrayEditor = __webpack_require__(45);
...
var Homes = function (_React$Component) {
  ...
  function Homes(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Homes.__proto__ || Object.getPrototypeOf(Homes)).call(this, props));
  ...
  _createClass(Homes, [{
    ...
    value: function componentWillMount() {
      ...
      xhr.onload = function () {
        if (xhr.readyState === xhr.DONE) {
          ...
          if (xhr.status == 200) {
            var arr = JSON.parse(xhr.responseText);
            _this2.setState({ data: arr, show1: true });
          } else if (xhr.status == 400) {
            window.location.href = "/profile/products";
          } else if (xhr.status == 401) {
            window.location.href = "/";
    ...
    key: 'updateArray',
    value: function updateArray(data) {
      if (data == 'category') {
    ...
    key: 'updateArray1',
    value: function updateArray1(data) {
      var _this3 = this;
      ...
      if (data == 'category') {
        ...
        xhr.onload = function () {
          if (xhr.readyState === xhr.DONE) {
            ...
            if (xhr.status == 200) {
              var arr = JSON.parse(xhr.responseText);
              _this3.setState({ data: arr, show1: true });
            } else if (xhr.status == 400) {
              window.location.href = "/profile/products";
            } else if (xhr.status == 401) {
              window.location.href = "/";
        ...
        _xhr.onload = function () {
          if (_xhr.readyState === _xhr.DONE) {
            _body.className = _body.className.replace(" modalBlock", "");
            if (_xhr.status == 200) {
              var arr = JSON.parse(_xhr.responseText);
              if (arr.length > 0) {
                _this3.setState({ data2: arr, show2: true });
              } else {
                _this3.setState({ data2: arr, show2: true });
              }
    ...
    key: 'getItem',
    value: function getItem(thisId) {
      this.setState({ show2: false });
      return this.getItem1(thisId);
    }
  }, {
    key: 'getItem1',
    value: function getItem1(thisId) {
      var _this4 = this;
      ...
      xhr.onload = function () {
        if (xhr.readyState === xhr.DONE) {
          if (xhr.status == 200) {
            ...
            var arr = JSON.parse(xhr.responseText);
            if (arr.length > 0) {
              _this4.setState({ data2: arr, show2: true });
            } else {
              _this4.setState({ data2: arr, show2: true });
            }
          } else if (xhr.status == 401) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        show1 && _react2.default.createElement(_arrayEditor2.default, { urlUpd: '/updatecategories', urlAdd: '/savecategories', btnId: 'categbtn', array: this.state.data, idName: '_id',
        ...
        show2 && _react2.default.createElement(_arrayEditor2.default, { urlUpd: '/updateitem', urlAdd: '/saveitem', btnId: 'itembtn', array: this.state.data2,
...
var _reactRouterLastLocation = __webpack_require__(22);

var _homes = __webpack_require__(46);
...
var Profile = function Profile(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouterDom.Route, { path: "/profile/settings", component: _settings2.default }),
    _react2.default.createElement(_reactRouterDom.Route, { path: "/profile/edit", component: _homes2.default }),
    _react2.default.createElement(_reactRouterDom.Route, { path: "/profile/products", component: _products2.default }),
    _react2.default.createElement(_reactRouterDom.Route, { path: "/profile/users", component: _users2.default }),
    checkurl(lastLocation)
  );
};

exports.default = (0, _reactRouterLastLocation.withLastLocation)(Profile);
...
function checkurl(x) {
  ...
  xhr.onload = function () {
    if (xhr.readyState === xhr.DONE) {
      if (xhr.status === 200) {
        var myobject1 = JSON.parse(xhr.responseText);
        localStorage.setItem('login', myobject1.login);
        localStorage.setItem('email', myobject1.email);
        localStorage.setItem('password', myobject1.password);
        localStorage.setItem('name', myobject1.name);
        localStorage.setItem('age', myobject1.age);
        localStorage.setItem('gender', myobject1.gender);
        localStorage.setItem('role', myobject1.role);
        body.className = body.className.replace(" modalBlock", "");
      } else if (xhr.status === 400) {
        var myobject2 = JSON.parse(xhr.responseText);
        localStorage.setItem('role', myobject2.role);
        body.className = body.className.replace(" modalBlock", "");
...
var _compare = __webpack_require__(48);
...
var _validation = __webpack_require__(53);
...
var _registr = __webpack_require__(54);
  ...
  _createClass(Regist, [{
    ...
    value: function render() {
      ...
      var store = function store(e) {
        ...
        var pas = (0, _jsSha2.default)(userPw.value);
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(67),B=__webpack_require__(25),C=__webpack_require__(10),ba=__webpack_require__(66),da=__webpack_require__(65),ea=__webpack_require__(64),fa=__webpack_require__(63),ia=__webpack_require__(60),D=__webpack_require__(24);
...
var m=__webpack_require__(25),n=__webpack_require__(24),p=__webpack_require__(10),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var _registration = __webpack_require__(55);
...
var Index = function Index() {
  return _react2.default.createElement(
    ...
    null,
    _react2.default.createElement(
      _reactRouterLastLocation.LastLocationProvider,
      null,
      _react2.default.createElement(
        "div",
        null,
