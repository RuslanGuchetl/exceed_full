...
var ArrayEditor = function (_React$Component) {
  ...
  _createClass(ArrayEditor, [{
    key: 'edit',
    value: function edit(date) {
      date = date.trim();
      if (date.match(/^([A-za-z]{3,15})([\s\/.\-]?)((\w+)?)$/)) {
        for (var i = 0; i < this.props.array.length; i++) {
          if (this.props.array[i] == this.state.currentHome) {
            this.props.array[i][this.props.field] = date;
            this.setState({ selectedLabel: date });
          }
        }
      } else {
...
var _bd = __webpack_require__(45);
...
var Homes = function (_React$Component) {
  ...
  _createClass(Homes, [{
    key: 'getItem',
    value: function getItem(date, val) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_arrayEditor2.default, { array: _bd.homes, idName: '_id', field: 'homeName', title: 'home', getHome: this.getItem.bind(this) }),
        show && _react2.default.createElement(_arrayEditor2.default, { array: this.state.item, idName: 'id', field: 'roomName', title: 'room' })
      );
    }
  }]);
